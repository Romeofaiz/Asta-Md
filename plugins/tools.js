...
smd(
  ...
  async (message) => {
    const SupportMsg = `𝙍𝙊𝙈𝙀𝙆-𝙓𝘿 𝙎𝙐𝙋𝙋𝙊𝙍𝙏 𝙂𝙧𝙤𝙪𝙥\n\n *ʟɪɴᴋ:* https://chat.whatsapp.com/DpwQMl9PrT545z3841Ld5I\n\n ${Config.botname} *WORKS*`;
